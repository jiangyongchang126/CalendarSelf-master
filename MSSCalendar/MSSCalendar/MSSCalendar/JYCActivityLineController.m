...
@interface JYCActivityLineController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation JYCActivityLineController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell)
    {
        ...
        if(calendarItem.day > 0)
        {
            ...
            if (self.calendarType == MSSCalendarActivityType) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.calendarType == MSSCalendarActivityType) {
        ...
        if([_delegate respondsToSelector:@selector(calendarActivityClickWithStartDate:)])
        {
            [_delegate calendarActivityClickWithStartDate:_startDate];
        }
